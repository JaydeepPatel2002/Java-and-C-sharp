...
namespace DataStructureCommon
{
    public abstract class A_Collection<T> : I_Collection<T> where T : IComparable<T>
    {
        ...
        //Note that the current implementation of Count is probably not very efficient.
        ...
        //A default implementation so we don't have to worry about this method later
